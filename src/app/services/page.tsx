import { Plane, Home, FileCheck, ShoppingCart, Warehouse, Check } from "lucide-react";
import Link from "next/link";

const services = [
  { icon: Plane, title:"Fret Air Express", price:"Dès 12$/kg", time:"10-15 jours", desc:"Rapide, léger, valeur. Idéal e-commerce & téléphones. Par avion.", features:["Vol quotidien","Suivi temps réel","Paiement à livraison"]},
  { icon: Plane, title:"Fret Air Éco", price:"Dès 10$/kg", time:"12-15 jours", desc:"Optimisé volume mais toujours par avion. Plus économique.", features:["Regroupement gratuit","Assurance incluse","Dédouanement inclus"]},
  { icon: Home, title:"Door-to-Door", price:"Tout inclus", time:"10-15j", desc:"On gère enlèvement usine → livraison chez vous par avion.", features:["Enlèvement usine","Livraison 48 wilayas","0 paperasse"]},
  ...
  return (
    <div className="mx-auto max-w-[1280px] px-4 md:px-6 py-8 md:py-12">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <h1 className="font-black text-4xl md:text-5xl tracking-tighter leading-none mt-3">Un service pour <span className="text-[#E63946]">chaque besoin</span> — par avion</h1>
        <p className="text-black/60 mt-4">Que vous importiez 5kg ou 5 tonnes, 100% par avion 10-15 jours.</p>
      </div>
